...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center px-4">
      <div className="max-w-4xl w-full rounded-2xl shadow-xl border border-slate-200/60 overflow-hidden grid lg:grid-cols-2 bg-white backdrop-blur-sm">
        {/* Left Pane */}
        <div className="bg-gradient-to-br from-primary to-primary/90 text-primary-foreground p-8 flex flex-col items-center justify-center relative">
        ...
        <div className="p-8 flex flex-col justify-center">
          <div className="space-y-2">
            <div className="space-y-1 text-center">
              <h1 className="text-xl font-bold text-slate-900">Login to Portal</h1>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 h-10 text-sm border-slate-300 focus:border-primary"
                    required
                  />
                  <button
                    type="button"
              ...
              <div className="space-y-1">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <Button
                    ...
                    disabled={isLoading}
                    className="p-2 h-10 border-slate-300 hover:bg-slate-50"
                  >
              ...
              <Button
                type="submit"
                className="w-full bg-primary hover:bg-primary/90 text-white font-medium py-2.5 h-10 rounded-lg shadow-sm hover:shadow-md transition-all text-sm"
                disabled={isLoading}
              >
                {isLoading ? (
            ...
            <div className="pt-4 text-xs text-center space-y-2">
              <div className="flex justify-between text-primary font-medium">
                <Link href="/forgot-password" className="hover:underline transition-colors">Forgot Password?</Link>
                <Link href="/forgot-email" className="hover:underline transition-colors">Forgot Email?</Link>
              </div>
              <div className="text-muted-foreground">
                {"Don't have an account? "}
                <Link href="/register" className="text-primary font-medium hover:underline transition-colors">Create Account</Link>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <Button
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 h-10 border-slate-300 hover:bg-slate-50 transition-colors text-sm"
                disabled={isLoading}
              >
