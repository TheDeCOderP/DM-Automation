...
export default function HelpCenterPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-black relative">
      ...
      <div className="absolute inset-0 bg-[url('/subtle-pattern.png')] opacity-[0.02] pointer-events-none"></div>
        ...
        <div className="w-full bg-gradient-to-r from-black to-gray-900 text-white">
          <div className="max-w-5xl mx-auto px-6 py-5 text-center">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Have questions about our printing services? Need a custom quote?
              <br className="hidden md:inline" /> Our team is ready to assist you with all your printing needs.
            </p>
          </div>
        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      required
                      className="w-full min-h-[150px] border-gray-300 focus:border-black focus:ring-black"
                    />
                  </div>
                  ...
                  <div>
                    <Button
                      ...
                      className="bg-black text-white hover:bg-gray-900 rounded-none px-8 py-6 text-base font-medium w-full md:w-auto"
                    >
                      {isSubmitting ? (
                        <>Processing...</>
                      ) : (
              ...
              <div className="bg-gray-50 border border-gray-200 p-8 h-full">
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-black flex items-center justify-center text-white flex-shrink-0">
                      <Mail size={20} />
                    </div>
                    <div>
                      <h4 className="text-lg font-semibold mb-1">Email Us</h4>
                      <p className="text-gray-600 mb-1">For general inquiries:</p>
                      <a href="mailto:info@prabisha.com" className="text-black hover:underline">
                        info@prabisha.com
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+07867090363" className="text-black hover:underline">
                        +44 (0) 7867090363
                      </a>
                    </div>
                  </div>
